...
exception).  This mechanism is impossible without agent-specific span
...
privacy levels, confirming that metadata-level capture suffices.
...
tool coverage.''  While this approximates rather than replaces a human
study, the effect size suggests that typed spans substantially reduce
