...
| **Author** | [AgentTelemetry Contributors](https://github.com/AgentTelemetry) |
...
| **Related OTEPs** | [OTEP 0248 - Semantic Conventions for GenAI operations](https://github.com/open-telemetry/oteps/blob/main/text/0248-genai-semconv.md) |
...
This section describes the proposed conventions from the perspective of an operator or instrumentation author who would use them.
...
This section describes the detailed technical design of the proposed semantic conventions.
...
#### Attribute definition: `agent.span_kind`
...
#### Attribute definition: `llm.cost_usd`
...
The research paper associated with this project is available at [Zenodo](https://zenodo.org/) (DOI to be assigned upon publication).
